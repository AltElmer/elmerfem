...
!print*,fx,sum(basis(1:nd)*f)
      ...
      CALL CheckValue(ddiff(1,1),SUM(ddxFromNodaldx(1:nd,1,1)*f), 6.0d-7, 'dfxx')
      CALL CheckValue(ddiff(1,2),SUM(ddxFromNodaldx(1:nd,1,2)*f), 6.0d-7, 'dfxy')
      CALL CheckValue(ddiff(1,3),SUM(ddxFromNodaldx(1:nd,1,3)*f), 6.0d-7, 'dfxz')
      CALL CheckValue(ddiff(2,2),SUM(ddxFromNodaldx(1:nd,2,2)*f), 6.0d-7, 'dfyy')
      CALL CheckValue(ddiff(2,3),SUM(ddxFromNodaldx(1:nd,2,3)*f), 6.0d-7, 'dfyz')
      CALL CheckValue(ddiff(3,3),SUM(ddxFromNodaldx(1:nd,3,3)*f), 6.0d-7, 'dfzz')
    END DO
!------------------------------------------------------------------------------
